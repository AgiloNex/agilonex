...
export const posts: Post[] = [
  {
    slug: "agi-mito-hype-ou-verdade",
    publishedAt: "2026-08-15",
    readingMinutes: 10, // Estimated reading time
    tags: ["ia", "agi", "inteligencia-artificial", "futuro", "tecnologia"],
    author: agilonexAuthor,
    title: {
      pt: "AGI: Mito, Hype ou Verdade? Um Papo Reto Sem Enrolação 🤖",
      en: "AGI: Myth, Hype, or Truth? A Straight Talk Without Embellishment 🤖", // Translated
      es: "AGI: ¿Mito, Hype o Verdad? Una Charla Directa Sin Rodeos 🤖", // Translated
    },
    excerpt: {
      pt: "Você já deve ter visto os dois extremos rolando no feed: um post dizendo que a AGI 'já chegou' e vai acabar com todos os empregos até o ano que vem, e logo em seguida outro dizendo que isso é ficção científica e não vai acontecer nem daqui 50 anos. Os dois não podem estar certos ao mesmo tempo — e a real é que nem os especialistas mais respeitados da área concordam entre si. Bora separar o que é papo furado do que é preocupação legítima.",
      en: "You've probably seen both extremes trending: one post claiming AGI 'has arrived' and will eliminate all jobs by next year, followed immediately by another dismissing it as science fiction, not happening for another 50 years. Both can't be right—and the truth is, even the most respected experts in the field disagree. Let's separate the empty talk from legitimate concerns.", // Translated
      es: "Seguramente ya ha visto los dos extremos en su feed: una publicación que dice que la AGI 'ya llegó' y acabará con todos los trabajos el año que viene, y justo después otra que dice que es ciencia ficción y no ocurrirá ni en 50 años. Ambos no pueden tener razón al mismo tiempo — y la verdad es que ni los expertos más respetados en el campo se ponen de acuerdo. Vamos a separar lo que es charlatanería de lo que es una preocupación legítima.", // Translated
    },
    content: {
      pt: [
        { type: "heading", level: 2, text: "Primeiro, o que é AGI mesmo?" },
        { type: "paragraph", text: "AGI (Artificial General Intelligence, ou Inteligência Artificial Geral) é o conceito de um sistema capaz de aprender e executar qualquer tarefa cognitiva que um ser humano consegue fazer — não só ser bom numa coisa específica, mas generalizar de verdade: aprender algo totalmente novo sem precisar de milhares de exemplos, aplicar raciocínio em situações nunca vistas, ter senso comum sobre como o mundo funciona." },
        { type: "paragraph", text: "Isso é bem diferente da IA que você usa hoje (ChatGPT, Claude, Gemini e companhia), que é IA 'estreita' — excelente, às vezes sobre-humana, em tarefas específicas, mas sem essa generalização ampla." },
        { type: "paragraph", text: "E aqui já vai o primeiro plot twist: **nem existe uma definição 100% consensual de AGI**. Cada grande laboratório usa um critério um pouco diferente — alguns falam em 'trabalho economicamente relevante', outros em 'qualquer tarefa cognitiva humana', outros em 'não falhar de um jeito que surpreenderia uma pessoa fazendo a mesma tarefa'. Ou seja: antes de discutir QUANDO a AGI chega, seria bom todo mundo combinar O QUE exatamente está esperando." },
        { type: "heading", level: 2, text: "Mitos 🚫" },
        { type: "heading", level: 3, text: "'A IA que eu uso todo dia já é AGI, ou tá quase lá'" },
        { type: "paragraph", text: "Não, pelo consenso técnico atual. Os modelos de ponta hoje superam humanos em várias benchmarks específicas — mas ainda tropeçam em coisas como aprender algo genuinamente novo com pouquíssimos exemplos, raciocínio causal e senso comum sobre o mundo físico. É 'IA estreita extremamente ampla', o que já é impressionante, mas ainda não é a mesma coisa que inteligência geral." },
        { type: "heading", level: 3, text: "'Existe um prazo certo, e todo mundo concorda quando a AGI chega'" },
        { type: "paragraph", text: "Esse talvez seja o mito mais forte de todos. É um dos temas com maior divergência entre gente séria da área hoje: de um lado, CEOs de grandes labs falando em 'poucos anos'; do outro, pesquisadores de peso argumentando que a arquitetura atual nunca vai chegar lá sem uma virada conceitual. No meio, um monte de gente estimando qualquer coisa entre 5 e 30+ anos. E tem um detalhe engraçado: desde os anos 1950, é comum pesquisador prever 'IA de nível humano' para 'daqui uns 15 a 25 anos' — recorrentemente, década após década. Se isso não te deixa cético, deveria." },
        { type: "heading", level: 3, text: "'Quando a AGI chegar, vai ser tipo filme de robô que se rebela e assume o controle'" },
        { type: "paragraph", text: "Isso é ficção científica, não é o cenário que preocupa quem trabalha com segurança de IA de verdade. As preocupações reais giram muito mais em torno de perda de controle sobre sistemas otimizando para objetivos mal especificados, concentração de poder nas mãos de quem controla esses sistemas, uso malicioso e disrupção econômica em larga escala. Curiosamente, mesmo sem esse tom hollywoodiano, tem gente pesada da área (inclusive um dos nomes fundadores do deep learning) dando probabilidade nada trivial pra cenários bem ruins — só que o motivo nunca é 'robô do mal', é sistema poderoso demais otimizando na direção errada." },
        { type: "heading", level: 3, text: "'Basta colocar mais poder computacional que a AGI aparece sozinha'" },
        { type: "paragraph", text: "Esse é um dos debates mais acalorados entre os próprios pesquisadores. Um grupo aposta que só escalar dados e computação continua entregando ganhos e eventualmente destrava capacidades gerais. Outro grupo — com nomes de peso como Yann LeCun (Meta) e Gary Marcus — argumenta que a arquitetura atual (os famosos transformers) já bateu ou vai bater num teto, e que faltam peças fundamentais que escala sozinha não resolve, como modelos de mundo de verdade e planejamento genuíno." },
        { type: "heading", level: 3, text: "'AGI é sinônimo de robô consciente, com sentimentos e vontade própria'" },
        { type: "paragraph", text: "Isso mistura dois assuntos bem diferentes. AGI, na definição técnica, é sobre capacidade cognitiva — fazer qualquer tarefa que um humano faz. Consciência e senciência são outro papo inteiro, filosófico, sem resposta definitiva até hoje — a ciência nem tem um jeito confiável de medir consciência em outro ser humano, imagina numa máquina. É perfeitamente possível imaginar um sistema hiper capaz sem nada parecido com experiência subjetiva." },
        { type: "heading", level: 2, text: "Verdades ✅" },
        { type: "heading", level: 3, text: "Os prazos estimados encolheram bastante nos últimos anos" },
        { type: "paragraph", text: "Comunidades de previsão que há poucos anos apostavam 'umas cinco décadas' pra algo parecido com AGI hoje falam em probabilidade relevante já para o final desta década. Isso não é só hype de marketing — é atualização real de gente que leva a própria reputação na previsão, baseada em quanto a capacidade dos modelos surpreendeu nos últimos anos." },
        { type: "heading", level: 3, text: "Mercados de previsão, com dinheiro real em jogo, são bem mais céticos que discurso de CEO" },
        { type: "paragraph", text: "Enquanto executivo de laboratório de IA fala em 'poucos anos' ou 'ainda essa década', plataformas onde pessoas apostam dinheiro de verdade costumam precificar probabilidades bem mais baixas pra prazos curtos. Boa regra prática: separe sempre 'o que o CEO disse numa entrevista' de 'no que analistas calibrados, sem interesse comercial em hype, estão realmente apostando'." },
        { type: "heading", level: 3, text: "Segurança e alinhamento de IA não são papo de ficção científica" },
        { type: "paragraph", text: "Todos os grandes laboratórios (e várias universidades) têm equipes inteiras dedicadas só a isso: garantir que sistemas cada vez mais capazes façam o que a gente realmente quer, e não uma versão distorcida e mal especificada disso. Não é paranoia — é o tipo de engenharia de risco que qualquer tecnologia poderosa exige." },
        { type: "heading", level: 3, text: "Você não precisa esperar a AGI pra sentir o impacto da IA" },
        { type: "paragraph", text: "Mesmo sem inteligência geral, os modelos de hoje já estão mudando fluxo de trabalho, automatizando tarefas inteiras e remodelando categorias de emprego. O debate sobre AGI é fascinante, mas o impacto prático no seu dia a dia como dev, criador de conteúdo ou empreendedor já está rolando com a IA 'estreita' mesmo." },
        { type: "heading", level: 3, text: "Ninguém tem certeza real — nem os mais confiantes" },
        { type: "paragraph", text: "Mesmo entre os otimistas mais vocais, previsões mudam pra frente e pra trás toda vez que sai um modelo novo. A postura mais honesta — pra ler notícia ou pra planejar seu negócio — é levar qualquer previsão específica (inclusive a de quem escreveu este post 😄) com um pé atrás, e prestar atenção nos sinais concretos de capacidade, não na data que alguém chutou numa entrevista." },
        { type: "heading", level: 2, text: "Fechando o papo" },
        { type: "paragraph", text: "A verdade sobre AGI é bem menos sexy que os dois extremos que rolam por aí — nem 'já chegou e vai dominar tudo amanhã', nem 'isso é ficção científica que nunca vai acontecer'. É um campo com progresso real e rápido, incerteza genuína e discordância séria até entre quem mais entende do assunto. Isso não é motivo pra pânico nem pra ignorar o assunto — é motivo pra acompanhar com curiosidade saudável e ceticismo em doses iguais." },
        { type: "paragraph", text: "E aí, você tava mais no time 'já chegou' ou no time 'é tudo exagero'? 👇" },
      ],
      en: [
        { type: "heading", level: 2, text: "First, what exactly is AGI?" },
        { type: "paragraph", text: "AGI (Artificial General Intelligence) is the concept of a system capable of learning and executing any cognitive task a human can do — not just being good at one specific thing, but truly generalizing: learning something completely new without needing thousands of examples, applying reasoning to unseen situations, having common sense about how the world works." },
        { type: "paragraph", text: "This is quite different from the AI you use today (ChatGPT, Claude, Gemini, and company), which is 'narrow' AI — excellent, sometimes superhuman, at specific tasks, but without this broad generalization." },
        { type: "paragraph", text: "And here's the first plot twist: **there isn't even a 100% consensual definition of AGI**. Each major lab uses a slightly different criterion — some talk about 'economically relevant work,' others about 'any human cognitive task,' others about 'not failing in a way that would surprise a person doing the same task.' In other words: before discussing WHEN AGI arrives, it would be good for everyone to agree on WHAT exactly they are waiting for." },
        { type: "heading", level: 2, text: "Myths 🚫" },
        { type: "heading", level: 3, text: "'The AI I use every day is already AGI, or almost there'" },
        { type: "paragraph", text: "No, according to current technical consensus. Today's cutting-edge models surpass humans in several specific benchmarks — but they still stumble on things like genuinely learning something new with very few examples, causal reasoning, and common sense about the physical world. It's 'extremely broad narrow AI,' which is already impressive, but still not the same as general intelligence." },
        { type: "heading", level: 3, text: "'There's a definite timeline, and everyone agrees when AGI will arrive'" },
        { type: "paragraph", text: "This is perhaps the strongest myth of all. It's one of the most divergent topics among serious people in the field today: on one side, CEOs of major labs talking about 'a few years'; on the other, respected researchers arguing that the current architecture will never get there without a conceptual breakthrough. In between, many people estimate anywhere from 5 to 30+ years. And there's a funny detail: since the 1950s, it's common for researchers to predict 'human-level AI' for 'about 15 to 25 years from now' — recurrently, decade after decade. If that doesn't make you skeptical, it should." },
        { type: "heading", level: 3, text: "'When AGI arrives, it will be like a robot movie where it rebels and takes control'" },
        { type: "paragraph", text: "This is science fiction; it's not the scenario that truly worries those who work with AI safety. Real concerns revolve much more around loss of control over systems optimizing for poorly specified goals, concentration of power in the hands of those who control these systems, malicious use, and large-scale economic disruption. Curiously, even without this Hollywood tone, some serious people in the field (including one of the founding names of deep learning) assign a non-trivial probability to very bad scenarios — but the reason is never 'evil robot'; it's an overly powerful system optimizing in the wrong direction." },
        { type: "heading", level: 3, text: "'Just add more computational power and AGI will appear by itself'" },
        { type: "paragraph", text: "This is one of the most heated debates among researchers themselves. One group bets that just scaling data and computation continues to deliver gains and eventually unlocks general capabilities. Another group — with prominent names like Yann LeCun (Meta) and Gary Marcus — argues that the current architecture (the famous transformers) has already hit or will hit a ceiling, and that fundamental pieces that scaling alone won't solve are missing, such as true world models and genuine planning." },
        { type: "heading", level: 3, text: "'AGI is synonymous with a conscious robot, with feelings and free will'" },
        { type: "paragraph", text: "This mixes two very different topics. AGI, in the technical definition, is about cognitive ability — performing any task a human does. Consciousness and sentience are a whole other philosophical discussion, with no definitive answer to this day — science doesn't even have a reliable way to measure consciousness in another human being, let alone in a machine. It's perfectly possible to imagine a hyper-capable system without anything resembling subjective experience." },
        { type: "heading", level: 2, text: "Truths ✅" },
        { type: "heading", level: 3, text: "Estimated timelines have shrunk considerably in recent years" },
        { type: "paragraph", text: "Forecasting communities that a few years ago predicted 'about five decades' for something similar to AGI now talk about a relevant probability as early as the end of this decade. This isn't just marketing hype — it's a real update from people who stake their reputation on predictions, based on how much model capabilities have surprised in recent years." },
        { type: "heading", level: 3, text: "Prediction markets, with real money at stake, are much more skeptical than CEO rhetoric" },
        { type: "paragraph", text: "While AI lab executives talk about 'a few years' or 'still this decade,' platforms where people bet real money tend to price much lower probabilities for short timelines. Good rule of thumb: always separate 'what the CEO said in an interview' from 'what calibrated analysts, with no commercial interest in hype, are actually betting on.'" },
        { type: "heading", level: 3, text: "AI safety and alignment are not science fiction" },
        { type: "paragraph", text: "All major labs (and several universities) have entire teams dedicated solely to this: ensuring that increasingly capable systems do what we truly want, and not a distorted and poorly specified version of it. It's not paranoia — it's the type of risk engineering that any powerful technology demands." },
        { type: "heading", level: 3, text: "You don't need to wait for AGI to feel AI's impact" },
        { type: "paragraph", text: "Even without general intelligence, today's models are already changing workflows, automating entire tasks, and reshaping job categories. The debate about AGI is fascinating, but the practical impact on your daily life as a developer, content creator, or entrepreneur is already happening with 'narrow' AI." },
        { type: "heading", level: 3, text: "No one is truly certain — not even the most confident" },
        { type: "paragraph", text: "Even among the most vocal optimists, predictions shift back and forth every time a new model is released. The most honest approach — for reading news or planning your business — is to take any specific prediction (including that of the author of this post 😄) with a grain of salt, and pay attention to concrete signs of capability, not the date someone guessed in an interview." },
        { type: "heading", level: 2, text: "Closing thoughts" },
        { type: "paragraph", text: "The truth about AGI is much less sexy than the two extremes circulating out there — neither 'it's already here and will take over everything tomorrow,' nor 'this is science fiction that will never happen.' It's a field with real and rapid progress, genuine uncertainty, and serious disagreement even among those who understand the most about the subject. This is no reason for panic or to ignore the topic — it's a reason to follow with healthy curiosity and equal doses of skepticism." },
        { type: "paragraph", text: "So, were you more on the 'it's already here' team or the 'it's all exaggerated' team? 👇" },
      ],
      es: [
        { type: "heading", level: 2, text: "Primero, ¿qué es la AGI exactamente?" },
        { type: "paragraph", text: "AGI (Inteligencia Artificial General) es el concepto de un sistema capaz de aprender y ejecutar cualquier tarea cognitiva que un ser humano puede hacer — no solo ser bueno en una cosa específica, sino generalizar de verdad: aprender algo totalmente nuevo sin necesidad de miles de ejemplos, aplicar el razonamiento en situaciones nunca vistas, tener sentido común sobre cómo funciona el mundo." },
        { type: "paragraph", text: "Esto es muy diferente de la IA que usas hoy (ChatGPT, Claude, Gemini y compañía), que es IA 'estrecha' — excelente, a veces sobrehumana, en tareas específicas, pero sin esa generalización amplia." },
        { type: "paragraph", text: "Y aquí va el primer giro de la trama: **ni siquiera existe una definición 100% consensuada de AGI**. Cada gran laboratorio usa un criterio un poco diferente — algunos hablan de 'trabajo económicamente relevante', otros de 'cualquier tarea cognitiva humana', otros de 'no fallar de una manera que sorprendería a una persona haciendo la misma tarea'. Es decir: antes de discutir CUÁNDO llega la AGI, sería bueno que todos se pusieran de acuerdo en QUÉ es exactamente lo que están esperando." },
        { type: "heading", level: 2, text: "Mitos 🚫" },
        { type: "heading", level: 3, text: "'La IA que uso todos los días ya es AGI, o está casi ahí'" },
        { type: "paragraph", text: "No, según el consenso técnico actual. Los modelos de vanguardia hoy superan a los humanos en varias pruebas específicas — pero todavía tropiezan en cosas como aprender algo genuinamente nuevo con muy pocos ejemplos, razonamiento causal y sentido común sobre el mundo físico. Es una 'IA estrecha extremadamente amplia', lo cual ya es impresionante, pero aún no es lo mismo que inteligencia general." },
        { type: "heading", level: 3, text: "'Hay un plazo fijo, y todos están de acuerdo cuándo llega la AGI'" },
        { type: "paragraph", text: "Este es quizás el mito más fuerte de todos. Es uno de los temas con mayor divergencia entre gente seria del área hoy: por un lado, CEOs de grandes laboratorios hablando de 'pocos años'; por el otro, investigadores de peso argumentando que la arquitectura actual nunca llegará allí sin un cambio conceptual. En el medio, mucha gente estima cualquier cosa entre 5 y 30+ años. Y hay un detalle curioso: desde los años 50, es común que los investigadores pronostiquen 'IA de nivel humano' para 'dentro de unos 15 a 25 años' — recurrentemente, década tras década. Si esto no te hace escéptico, debería." },
        { type: "heading", level: 3, text: "'Cuando llegue la AGI, será como en las películas de robots que se rebelan y toman el control'" },
        { type: "paragraph", text: "Esto es ciencia ficción; no es el escenario que preocupa a quienes trabajan seriamente con la seguridad de la IA. Las preocupaciones reales giran mucho más en torno a la pérdida de control sobre sistemas que se optimizan para objetivos mal especificados, la concentración de poder en manos de quienes controlan estos sistemas, el uso malicioso y la disrupción económica a gran escala. Curiosamente, incluso sin este tono hollywoodense, hay gente importante en el área (incluido uno de los nombres fundadores del deep learning) que da una probabilidad nada trivial a escenarios muy malos — solo que el motivo nunca es 'robot malvado', sino un sistema demasiado poderoso optimizando en la dirección equivocada." },
        { type: "heading", level: 3, text: "'Basta con poner más poder computacional y la AGI aparece sola'" },
        { type: "paragraph", text: "Este es uno de los debates más acalorados entre los propios investigadores. Un grupo apuesta a que solo escalar datos y computación seguirá dando beneficios y eventualmente desbloqueará capacidades generales. Otro grupo — con nombres de peso como Yann LeCun (Meta) y Gary Marcus — argumenta que la arquitectura actual (los famosos transformers) ya ha llegado o llegará a un techo, y que faltan piezas fundamentales que la escala por sí sola no resuelve, como modelos de mundo reales y planificación genuina." },
        { type: "heading", level: 3, text: "'AGI es sinónimo de robot consciente, con sentimientos y voluntad propia'" },
        { type: "paragraph", text: "Esto mezcla dos temas muy diferentes. AGI, en la definición técnica, trata sobre la capacidad cognitiva — realizar cualquier tarea que un humano hace. La conciencia y la senciencia son otro tema completamente distinto, filosófico, sin respuesta definitiva hasta hoy — la ciencia ni siquiera tiene una forma fiable de medir la conciencia en otro ser humano, imagínate en una máquina. Es perfectamente posible imaginar un sistema hipercapaz sin nada parecido a una experiencia subjetiva." },
        { type: "heading", level: 2, text: "Verdades ✅" },
        { type: "heading", level: 3, text: "Los plazos estimados se han reducido bastante en los últimos años" },
        { type: "paragraph", text: "Comunidades de predicción que hace pocos años apostaban 'unas cinco décadas' para algo parecido a la AGI hoy hablan de una probabilidad relevante ya para finales de esta década. Esto no es solo hype de marketing — es una actualización real de gente que arriesga su propia reputación en las predicciones, basada en cuánto ha sorprendido la capacidad de los modelos en los últimos años." },
        { type: "heading", level: 3, text: "Los mercados de predicción, con dinero real en juego, son mucho más escépticos que el discurso de los CEO" },
        { type: "paragraph", text: "Mientras los ejecutivos de laboratorios de IA hablan de 'pocos años' o 'todavía esta década', las plataformas donde la gente apuesta dinero de verdad suelen poner probabilidades mucho más bajas para plazos cortos. Buena regla práctica: separe siempre 'lo que dijo el CEO en una entrevista' de 'en lo que realmente están apostando analistas calibrados, sin interés comercial en el hype'." },
        { type: "heading", level: 3, text: "La seguridad y alineación de la IA no son cosa de ciencia ficción" },
        { type: "paragraph", text: "Todos los grandes laboratorios (y varias universidades) tienen equipos enteros dedicados solo a esto: garantizar que sistemas cada vez más capaces hagan lo que realmente queremos, y no una versión distorsionada y mal especificada de ello. No es paranoia — es el tipo de ingeniería de riesgos que cualquier tecnología poderosa exige." },
        { type: "heading", level: 3, text: "No necesitas esperar a la AGI para sentir el impacto de la IA" },
        { type: "paragraph", text: "Incluso sin inteligencia general, los modelos actuales ya están cambiando flujos de trabajo, automatizando tareas enteras y remodelando categorías de empleo. El debate sobre la AGI es fascinante, pero el impacto práctico en tu día a día como desarrollador, creador de contenido o emprendedor ya está ocurriendo con la IA 'estrecha'." },
        { type: "heading", level: 3, text: "Nadie tiene una certeza real — ni los más confiados" },
        { type: "paragraph", text: "Incluso entre los optimistas más vocales, las predicciones cambian constantemente cada vez que sale un nuevo modelo. La postura más honesta — para leer noticias o para planificar tu negocio — es tomar cualquier predicción específica (incluida la de quien escribió este post 😄) con cautela, y prestar atención a las señales concretas de capacidad, no a la fecha que alguien mencionó en una entrevista." },
        { type: "heading", level: 2, text: "Cerrando la charla" },
        { type: "paragraph", text: "La verdad sobre la AGI es mucho menos sexy que los dos extremos que circulan por ahí — ni 'ya llegó y lo dominará todo mañana', ni 'esto es ciencia ficción que nunca ocurrirá'. Es un campo con progreso real y rápido, incertidumbre genuina y serias discrepancias incluso entre quienes más entienden del tema. Esto no es motivo para el pánico ni para ignorar el tema — es motivo para seguirlo con curiosidad saludable y escepticismo a partes iguales." },
        { type: "paragraph", text: "¿Y tú, estabas más en el equipo 'ya llegó' o en el equipo 'todo es exagerado'? 👇" },
      ],
    },
  },
  {
