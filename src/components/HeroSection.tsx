        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tighter text-balance text-foreground">
              Automatize, Integre e Proteja seu Negócio com{" "}
              <span className="text-primary">Tecnologia</span>
            </h1>
            <p className="mt-6 text-lg text-muted-foreground max-w-[55ch] text-pretty">
              Soluções em IA, sistemas e privacidade de dados para empresas que
              querem crescer com eficiência, não burocracia.
            </p>
          ...
          >
            <img
              src={heroImg}
              alt="Ilustração de tecnologia conectada"
